...
from worker_app.lifecycle import LifecycleStoreError, NonceStoreFullError, SqliteNonceStore
...
def verify_worker_authorization(
    *,
    ...
    if nonce_store is not None:
        ...
        except NonceStoreFullError:
            return 503, "Worker nonce 存储已满，请稍后重试"
